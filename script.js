const baseCases = [
  { id: 1, title: "The Missing Laptop", brief: "Laptop mahasiswa hilang dari ruang belajar pada pukul 14:00–15:00. Satu alibi tidak cocok dengan jejak yang tertinggal.", level: 1, points: 18, liar: "Bella", characters: [{ name: "Alex", role: "Mahasiswa", avatar: "🧑‍🎓", base: "Aku berada di kantin. Aku ingat melihat banyak orang lewat.", questions: [["Kamu melihat seseorang?", "Chris lewat di dekat pintu sekitar 14:25, tapi aku tidak bicara dengannya."], ["Apa yang kamu lakukan di kantin?", "Membeli kopi. Struknya masih ada di sakuku."]] }, { name: "Bella", role: "Asisten lab", avatar: "👩‍💻", base: "Aku berada di perpustakaan sejak pukul 14:00.", questions: [["Ada yang melihatmu?", "Tidak... maksudku, mungkin ada yang melihatku di meja pojok."], ["Kenapa pesanmu menyebut kantin?", "Aku hanya salah mengetik. Aku tetap di perpustakaan."]] }, { name: "Chris", role: "Teknisi gedung", avatar: "🧑‍🔧", base: "Aku memperbaiki printer di lantai dua sampai pukul 15:00.", questions: [["Kamu melihat Alex?", "Aku melihatnya meninggalkan kantin sekitar 14:32."], ["Kamu masuk ruang belajar?", "Tidak, pintu ruang belajar sedang terkunci saat itu."]] }, { name: "Dina", role: "Mahasiswa", avatar: "👩‍🎨", base: "Aku berada di ruang kelas sepanjang waktu.", questions: [["Bisa dibuktikan?", "Dosen merekam kehadiran kami pukul 14:40."], ["Kamu kenal Bella?", "Kami satu kelompok, tapi tidak bertemu hari itu."]] }], evidence: [{ icon: "📹", title: "CCTV Lantai Dua", text: "Terlihat seseorang dengan tas merah memasuki perpustakaan pukul 14:32.", tag: "TIME · 14:32", key: "cctv" }, { icon: "📱", title: "Pesan Bella", text: "14:35 — Bella: ‘Aku masih di kantin, tunggu sebentar ya.’", tag: "MESSAGE · 14:35", key: "message" }, { icon: "🧾", title: "Struk Kantin", text: "Kopi atas nama Alex, tercetak pukul 14:18.", tag: "RECEIPT · 14:18", key: "receipt" }, { icon: "🔐", title: "Access Log", text: "Kartu Bella membuka pintu perpustakaan pukul 14:31.", tag: "LOG · 14:31", key: "log" }, { icon: "📸", title: "Foto Kelas", text: "Dina terlihat di kelas dalam foto kegiatan pukul 14:40.", tag: "PHOTO · 14:40", key: "photo" }, { icon: "🗺️", title: "Floor Map", text: "Kantin dan perpustakaan berada di gedung berbeda.", tag: "LOCATION", key: "map" }], locations: [{ time: "14:18", text: "Alex tercatat di Kantin Utara — struk mendukung." }, { time: "14:31", text: "Kartu Bella membuka Perpustakaan." }, { time: "14:32", text: "CCTV: seseorang bertas merah masuk perpustakaan." }, { time: "14:40", text: "Dina tercatat hadir di Ruang Kelas 2B." }], timeline: [{ time: "14:18", text: "Alex membeli kopi di kantin." }, { time: "14:31", text: "Kartu akses membuka perpustakaan." }, { time: "14:32", text: "Seseorang masuk perpustakaan." }, { time: "14:35", text: "Pesan Bella mengaku masih di kantin." }], messages: [{ avatar: "👩‍💻", name: "Bella → Maya", text: "14:35 — Aku masih di kantin, tunggu sebentar ya." }, { avatar: "🧑‍🎓", name: "Alex → Chris", text: "14:20 — Kopinya enak, aku balik ke ruang belajar." }], solution: "Bella mengatakan berada di perpustakaan, tetapi pesannya pada 14:35 menyebut ia masih di kantin. Access log memang menunjukkan kartunya di perpustakaan pada 14:31, sehingga rangkaian waktunya tidak konsisten.", links: [["Bella", "Pesan Bella"], ["Pesan Bella", "14:35"], ["14:35", "Kantin"]] },
  { id: 2, title: "The Missing Fund", brief: "Uang kas kelas sebesar Rp500.000 hilang dari laci pada pukul 10:00–10:30. Lima cerita harus dibandingkan.", level: 2, points: 20, liar: "Bima", characters: [{ name: "Adit", role: "Bendahara", avatar: "🧑‍💼", base: "Aku pergi ke perpustakaan pukul 10:00 untuk mengembalikan buku.", questions: [["Kapan kembali?", "Sekitar 10:35, setelah bertemu petugas."], ["Ada yang melihatmu?", "Petugas perpustakaan, mungkin."]] }, { name: "Bima", role: "Ketua kelas", avatar: "👨‍🏫", base: "Aku berada di kelas bersama Citra sepanjang waktu.", questions: [["Citra mendukung ceritamu?", "Tentu... dia duduk di sebelahku. Setidaknya sampai 10:15."], ["Mengapa CCTV melihatmu di lorong?", "Aku hanya keluar sebentar mengambil spidol."]] }, { name: "Citra", role: "Sekretaris", avatar: "👩‍💼", base: "Bima meninggalkan kelas pukul 10:15 dan belum kembali saat aku pergi.", questions: [["Kamu pergi ke mana?", "Ke ruang fotokopi pada 10:22."], ["Apakah Bima membawa sesuatu?", "Dia membawa map biru."]] }, { name: "Dina", role: "Mahasiswa", avatar: "👩‍🎓", base: "Aku melihat Adit dekat ruang kelas sekitar 10:20.", questions: [["Yakin itu Adit?", "Tasnya sama, jadi cukup yakin."], ["Ada orang lain?", "Aku melihat Bima di ujung lorong juga."]] }, { name: "Eka", role: "Mahasiswa", avatar: "🧑‍🎨", base: "Aku tidak pernah masuk kelas hari itu. Aku berada di studio seni.", questions: [["Ada bukti?", "Kartu studio tercatat pukul 10:05."], ["Kamu melihat Bima?", "Tidak, hanya mendengar suara langkah di lorong."]] }], evidence: [{ icon: "📹", title: "CCTV Lorong", text: "Bima terlihat meninggalkan kelas pukul 10:15 membawa map biru.", tag: "CCTV · 10:15", key: "cctv" }, { icon: "🗝️", title: "Laci Kelas", text: "Kunci laci hanya dipinjam Bima dan Adit pada hari itu.", tag: "KEY LOG", key: "key" }, { icon: "📋", title: "Daftar Fotokopi", text: "Citra tercatat di mesin fotokopi pukul 10:22.", tag: "LOG · 10:22", key: "copy" }, { icon: "📱", title: "Pesan Bima", text: "10:18 — ‘Aku masih duduk di kelas, rapat sebentar lagi.’", tag: "MESSAGE · 10:18", key: "message" }, { icon: "🗺️", title: "Peta Gedung", text: "Ruang fotokopi berada di seberang kelas, melewati lorong CCTV.", tag: "LOCATION", key: "map" }], locations: [{ time: "10:05", text: "Eka terdeteksi di Studio Seni." }, { time: "10:15", text: "Bima meninggalkan Kelas 2B membawa map biru." }, { time: "10:18", text: "Pesan Bima mengaku masih duduk di kelas." }, { time: "10:22", text: "Citra menuju ruang fotokopi." }], timeline: [{ time: "10:05", text: "Eka check-in di studio seni." }, { time: "10:15", text: "Bima keluar dari kelas." }, { time: "10:18", text: "Bima mengirim pesan dengan alibi kelas." }, { time: "10:22", text: "Citra tercatat di ruang fotokopi." }], messages: [{ avatar: "👨‍🏫", name: "Bima → Grup Kelas", text: "10:18 — Aku masih duduk di kelas, rapat sebentar lagi." }, { avatar: "👩‍💼", name: "Citra → Adit", text: "10:24 — Bima tadi keluar membawa map biru." }], solution: "Bima mengatakan masih duduk di kelas pada 10:18, tetapi CCTV menunjukkan ia pergi pada 10:15. Citra dan pesan Bima membuat kontradiksi waktu ini terlihat jelas.", links: [["Bima", "CCTV Lorong"], ["CCTV Lorong", "10:15"], ["10:15", "Pesan Bima"]] },
];
